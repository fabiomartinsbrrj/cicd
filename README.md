...
2. Add following snippet there:
        ...
        <datasource jndi-name="java:jboss/datasources/cicdDataSource" pool-name="cicdDataSource" enabled="true" use-java-context="true">
            <connection-url>jdbc:h2:~/cicdDatabase;AUTO_SERVER=TRUE</connection-url>
            <driver>h2</driver>
            <security>
...
2. Add following snippet there:
        ...
        <security-domain name="cicdSecurityDomain" cache-type="default">
            <authentication>
                <login-module code="Database" flag="required">
                    <module-option name="dsJndiName" value="java:jboss/datasources/cicdDataSource"/>
...
2. Add following snippet to log all messages from the application:
        ...
        <logger category="com.fvm.poc.cicd">
            <level name="ALL"/>
        </logger>
